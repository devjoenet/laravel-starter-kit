...
<template>
  ...
  >
    <DatePickerCalendar v-slot="{ weekDays, grid }" class="max-h-[inherit] overflow-auto p-2">
      ...
      <DatePickerGrid v-for="month in grid" :key="month.value.toString()" class="w-full border-collapse space-y-1 select-none">
        <DatePickerGridHead>
