<script lang="ts" setup>
  ...
  const classes = computed(() => toggleVariants({ color: props.color, size: props.size }) + (props.disabled ? " opacity-50 cursor-not-allowed" : ""));
...
<template>
  <div class="flex items-center">
    <input :id="inputId" type="checkbox" role="switch" :class="classes" :checked="props.modelValue" :disabled="props.disabled" @change="onChange" />
